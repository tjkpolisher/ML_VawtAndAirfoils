...
with mirrored_strategy.scope():
    ...
    x_ = tf.keras.layers.MaxPooling2D((2, 1), padding='same')(x_conv)
    ...
    sd.save('AeroCNN_I_256kernels1StrideMaxpoolingSameCNNpoolingSame.h5', overwrite=True, include_optimizer=True, save_format='h5')
