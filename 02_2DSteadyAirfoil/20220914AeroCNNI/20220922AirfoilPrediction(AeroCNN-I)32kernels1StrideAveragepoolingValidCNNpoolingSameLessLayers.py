...
with mirrored_strategy.scope():
    ...
    x_ = tf.keras.layers.AveragePooling2D((2, 1))(x_conv)
    ...
    sd.save('AeroCNN_I_32kernels1StrideAveragepoolingValidCNNpoolingSameLessLayers.h5', overwrite=True, include_optimizer=True, save_format='h5')
