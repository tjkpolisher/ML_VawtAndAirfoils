...
mirrored_strategy = tf.distribute.MirroredStrategy(["/GPU:0"], cross_device_ops = tf.distribute.HierarchicalCopyAllReduce())
...
model = tf.keras.models.load_model('AeroCNN-II_with_U-net_FlowFieldPrediction_50kernel_3x3_2by2MaxPooling_2CNNlayer_2block_testSize0.05.h5')
...
os.chdir("D:\\AeroCNNII_Images\\20221012\\AeroCNNII_2block")
...
plt.grid()
plt.tight_layout()
plt.savefig("20221012AeroCNNIIwithUnet(2CNNlayer_2block)(trainingeErrorDistribution).png",dpi=300)
plt.show()
...
plt.grid()
plt.tight_layout()
plt.savefig("20221012AeroCNNIIwithUnet(2CNNlayer_2block)(testErrorDistribution).png",dpi=300)
plt.show()
...
for c in range(0,16):
    ...
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)(training)" + str(np.array2string(geo_test[2*16+c])[3:-2])+str(aa_test[2*16+c])+".jpg"
...
for c in range(0,16):
    ...
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)" + str(np.array2string(geo_test[c])[3:-2])+str(aa_test[c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)(training)" + str(np.array2string(geo_train[c])[3:-2])+str(aa_train[c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)(training)" + str(np.array2string(geo_train[20*16+c])[3:-2])+str(aa_train[20*16+c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)_absoluteError_" + str(np.array2string(geo_test[2*16+c])[3:-2])+str(aa_test[2*16+c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    cbar = plt.colorbar(mappable, cax=cax, orientation="horizontal")
    cbar.set_label('Error', fontsize=15)
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)_absoluteError_" + str(np.array2string(geo_test[c])[3:-2])+str(aa_test[c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    cbar = plt.colorbar(mappable, cax=cax, orientation="horizontal")
    cbar.set_label('Error', fontsize=15)
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)_absoluteError_" + str(np.array2string(geo_train[c])[3:-2])+str(aa_train[c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
...
for c in range(0,16):
    ...
    cbar = plt.colorbar(mappable, cax=cax, orientation="horizontal")
    cbar.set_label('Error', fontsize=15)
    save_fig_name = "20221012AeroCNNIIwithUnet(2block_2CNNlayer)_absoluteError_" + str(np.array2string(geo_train[16*20+c])[3:-2])+str(aa_train[16*20+c])+".jpg"
    plt.savefig(save_fig_name)
    #plt.show()
